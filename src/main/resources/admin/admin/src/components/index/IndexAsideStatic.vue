<template>
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#F5F7FA">
        <div class="menulistImg" style="backgroundColor:#F5F7FA;padding:25px 0" v-if="true && menulistStyle == 'vertical'">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#F5F7FA" text-color="#5E6B71" active-text-color="#1E88E5" default-active="0">
