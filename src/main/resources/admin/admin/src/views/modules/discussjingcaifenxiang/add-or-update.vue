  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.refid" label="关联表id" prop="refid">
              <el-input v-model="ruleForm.refid" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.content" label="评论内容" prop="content">
              <el-input v-model="ruleForm.content" 
...
export default {
  ...
  methods: {
        ...
        for (var o in obj){
            ...
            continue;
                                ...
                                // 多级联动参数
                                          info(id) {
      this.$http({
        url: `discussjingcaifenxiang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `discussjingcaifenxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.discussjingcaifenxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
